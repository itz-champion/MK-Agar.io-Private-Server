...
function GameServer() {
    ...
    this.config = {
        ...
        /** SERVER **/
        serverTimeout: 60, // Seconds to keep connection alive for non-responding client
        ...
        playerRecombineTime: 0, // Base time in seconds before a cell is allowed to recombine
